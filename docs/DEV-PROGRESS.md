...
| REQ-B-A2-Auth-3 | CLI 직접 로그인 엔드포인트 | 4 | ✅ Done | 18 tests (100%), Commit: bb26b1a, Progress: docs/progress/REQ-B-A2-Auth-3.md |
...
| REQ ID | Feature | Phase | Status | Notes |
|--------|---------|-------|--------|-------|
| **REQ-AGENT-0-0** | **위험 관리 전략** | 0 | ⏳ Backlog | P0 CRITICAL - Feature flag로 Gemini만 적용 |
